...
namespace TestGenerator
{
	partial class Test
	{
		...
		static void buildScopeTest() {
			StreamWriter writer = new StreamWriter ("ScopeTest.cpp");
			writer.WriteLine ("#include \"Test.h\"\n\n");
			AppendTop ("ScopeTest.cpp");

			GenerateNameFuncTest (writer, "scopeOneNormal", "Int", "adder", "Int->Int->Int", "m n", "m+n", "true", "", "4");
			GenerateNameFuncTest (writer, "scopeSamePattern", "Int", "adder", "Int->Int->Int", "n n", "n+n", "false", "", "");
			GenerateNameFuncTest (writer, "scopeNoPattern", "Int", "adder", "Int->Int->Int", "m n", "n+o", "false", "", "");
			GenerateNameFuncTest (writer, "scopeTwoNormal", "Int", "adder", "Int->Int->Int", "m n", "m+n", "subber", "Int->Int->Int", "m n", "m-n", "true", "", "4"); // (1+2)-(3-4)
			GenerateNameFuncTest (writer, "scopeTwoSameName", "Int", "adder", "Int->Int->Int", "m n", "m+n", "adder", "Int->Int->Int", "m n", "m+n", "false", "", "");
			GenerateNameFuncTest (writer, "scopeFunctionOverload", "Int", "adder", "Int->Int->Int", "m n", "m+n", "adder", "Int->Int->Int->Int", "l m n", "l+m+n", "false", "", "");
			GenerateNameFuncTest (writer, "scopeNameFuncPat", "Int", "adder", "Int->Int->Int", "adder subber", "adder+subber", "subber", "Int->Int->Int", "subber adder", "subber-adder", "false", "", "");

			writer.Close ();
		}

		static void buildPrecedenceTest() {
			StreamWriter writer = new StreamWriter ("PrecedenceTest.cpp");
			writer.WriteLine ("#include \"Test.h\"\n\n");
			AppendTop ("ScopeTest.cpp");

			// SAME

			GenerateSimpleTestCase (writer, "precAndTrue", "Bool", "True && True && True", "true", "", "True");
			GenerateSimpleTestCase (writer, "precAndFalse", "Bool", "False&&False&&False", "true", "", "False");
			GenerateSimpleTestCase (writer, "precAndMix", "Bool", "True&&False&&True", "true", "", "False");

			GenerateSimpleTestCase (writer, "precOrTrue", "Bool", "True||True||True", "true", "", "True");
			GenerateSimpleTestCase (writer, "precOrFalse", "Bool", "False||False||False", "true", "", "False");
			GenerateSimpleTestCase (writer, "precOrMix", "Bool", "True||False||True", "true", "", "False");

			GenerateSimpleTestCase (writer, "precEqualTrue", "Bool", "True==True==True", "true", "", "True");
			GenerateSimpleTestCase (writer, "precEqualFalse", "Bool", "False==False==False", "true", "", "False");
			GenerateSimpleTestCase (writer, "precEqualMix", "Bool", "True==False==True", "true", "", "False");
